...
class DownloadOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--area_filter', type=float, default=0.6, help='Lakes with 2015 area below this quantile will not be downloaded')
        ...
        parser.add_argument('--max_snow', type=float, default=0.7, help='Maximum percentage of snow pixels to tolerate')
