...
class ProcessOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--in_dir', type=str, default='/datadrive/snake/lakes/le7-2015/', help='Absolute path to imagery to preprocess')
        ...
        parser.add_argument('--out_dir', type=str, default='/datadrive/snake/lakes/le7-2015/test/', help='Absolute path to directory to save train / val / test splits')
