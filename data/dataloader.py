...
def load_dataset(opts, kwargs=None):
    ...
    trn = StreamingGeospatialDataset(train_img_fns, stats_fn, train_label_fns, train_meta_fns, chip_size=opts.chip_size, num_chips_per_tile=20, image_transform=img_transforms, verbose=False)
    ...
    val_label_fns.sort()
    val_meta_fns.sort()
    val = StreamingGeospatialDataset(val_img_fns, stats_fn, val_label_fns, val_meta_fns, chip_size=opts.chip_size, num_chips_per_tile=10, image_transform=img_transforms, verbose=False)
