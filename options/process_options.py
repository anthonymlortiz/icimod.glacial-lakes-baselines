...
class ProcessOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--out_dir', type=str, default='/datadrive/snake/lakes/sentinel-2015/processed/brainstorm', help='Absolute path to directory to save train / val / test splits')
