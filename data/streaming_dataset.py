            ...
            try:
                ...
                while i < self.num_chips_per_tile:
                    ...
                    if self.subtile_bounds is None:
                        ...
                        x = np.random.randint(self.subtile_bounds[0], self.subtile_bounds[1]-self.chip_size)
                        y = np.random.randint(self.subtile_bounds[2], self.subtile_bounds[3]-self.chip_size)
